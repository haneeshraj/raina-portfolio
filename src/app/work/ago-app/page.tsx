        ...
        <div className={styles["project-info"]}>
          <div className={styles["project-info__cards"]}>
            ...
            <div className={styles["info-card"]}>
              ...
              <p className={styles["info-card__text"]}>
                <strong>Research</strong> — Market research, surveys,
              ...
              <p className={styles["info-card__text"]}>
                <strong>Usability Testing</strong> — Scenario based testing with
                7 participants.
              </p>
            </div>
          </div>
          ...
          <div className={styles.rmSection}>
            ...
            <div className={styles.rmGrid}>
              ...
              <div className={styles.rmItem}>
                ...
                <p className={styles.rmDuration}>1 week</p>
                <p className={styles.rmDesc}>
                  An analysis was conducted to compare AGO, ROM and MoMA. Also
                  mini SWOT analyses.
                </p>
              </div>
              <div className={styles.rmItem}>
              ...
              <div className={styles.surveyCards}>
                ...
                <div className={styles.surveyCard}>
                  <p className={styles.surveyCardText}>
                    ...
                    audio descriptions, visual representation (maybe through
                    VR))
                  </p>
                  <p className={styles.surveyCardCount}>1 response</p>
                </div>
                <div className={styles.surveyCard}>
                  <p className={styles.surveyCardText}>
                    ...
                    people are left to themselves — there might or might not be
                    a description about it, but regardless of that I feel there
        ...
        <div className={styles["project-phase"]}>
          ...
          <div className={styles.persona}>
            ...
            <div className={styles.personaBentoGrid}>
              {/* Avatar */}
              <div
                className={`${styles.personaBentoCard} ${styles.personaBentoAvatar}`}
              >
                <Image
                ...
                <div className={styles.personaAvatarInfo}>
                  ...
                  <ul className={styles.personaCardList}>
                    ...
                    <li>
                      <strong>Occupation:</strong> Art History Student
                    </li>
                    <li>
                      <strong>Location:</strong> Oakville, ON
                    </li>
                  </ul>
                </div>
              </div>
              ...
              {/* Background */}
              <div
                className={`${styles.personaBentoCard} ${styles.personaBentoBackground}`}
              >
                <p className={styles.personaBentoCardTitle}>🔍 Background</p>
                <ul className={styles.personaCardList}>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Loves art and
                    used to attend galleries and conventions regularly.
                  </li>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Researches
                    artwork and art history online daily for school.
                  </li>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Active on
                    social media &mdash; shares art discoveries with her
                    followers.
                  </li>
                </ul>
              </div>
              ...
              {/* Pain Points */}
              <div
                className={`${styles.personaBentoCard} ${styles.personaBentoPain}`}
              >
                <p className={styles.personaBentoCardTitle}>
                  <span>😕</span> Pain Points
                </p>
                <ul className={styles.personaCardList}>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Unable to
                    visit galleries or art events due to mobility limitations.
                  </li>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Commuting is
                    challenging due to lack of accessibility.
                  </li>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Existing apps
                    lack screen reader and audio description support.
                  </li>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Feels
                    disconnected from live art experiences and the community.
                  </li>
                </ul>
              </div>
              ...
              {/* Goals */}
              <div
                className={`${styles.personaBentoCard} ${styles.personaBentoGoals}`}
              >
                <p className={styles.personaBentoCardTitle}>
                  <span>🎯</span> Goals
                </p>
                <ul className={styles.personaCardList}>
                  <li>
                    <span className={styles.personaCheck}>✓</span>View art
                    comfortably without settling for Google images or YouTube
                    videos.
                  </li>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Access
                    detailed exhibit information including artist history and
                    context.
                  </li>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Explore
                    galleries through immersive 360&deg; and VR experiences.
                  </li>
                  <li>
                    <span className={styles.personaCheck}>✓</span>Find
                    accessible venue maps and wayfinding guides before visiting.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className={styles.journeyBlock}>
            ...
            <div className={styles.journeyLeft}>
              ...
              <h3 className={styles.journeyInsightHeading}>
                Elona&rsquo;s Journey
              </h3>
              <ul className={styles.journeyInsightList}>
                <li>
                  <strong>Accessibility Info Hard to Find:</strong> Key details
                  are buried in the website, making planning difficult.
                </li>
                <li>
                  <strong>Ticketing Confusion:</strong> Free annual pass for
                  young visitors is not prominently displayed.
                </li>
                <li>
                  <strong>Transport Planning:</strong> User books accessible
                  transport (Wheel-Trans) to ensure smooth travel.
                </li>
                <li>
                  <strong>Navigation Challenges:</strong> Finding the entrance
                  is easy, but unclear signage makes exiting difficult.
                </li>
              </ul>
            </div>
          ...
          <div className={`${styles.splitBlock} ${styles.splitBlockCream}`}>
            <div className={`${styles.splitSide} ${styles.splitCreamLeft}`}>
              ...
              <p className={styles.splitBodyText}>
                Using our Research, personas and journey map we have discovered
                4 key pain points.
              </p>
            </div>
              ...
              <div className={styles.findingsList}>
                <div className={styles.findingItem}>
                  ...
                  <p className={styles.findingText}>
                    Finding important information and content on the AGO website
                    is difficult. Especially information on accessibility.
                  </p>
                </div>
                <div className={styles.findingItem}>
                  <p className={styles.findingLabel}>Finding 2</p>
                  <p className={styles.findingText}>
                    Tour guide information is not present on the website. Users
                    need to call AGO for tour info.
                  </p>
                </div>
                <div className={styles.findingItem}>
                  <p className={styles.findingLabel}>Finding 3</p>
                  <p className={styles.findingText}>
                    Commuting to AGO is difficult for users who may be
                    unfamiliar with the area or users with disabilities.
                  </p>
                </div>
                <div className={styles.findingItem}>
                  <p className={styles.findingLabel}>Finding 4</p>
                  <p className={styles.findingText}>
                    Users find it difficult to navigate through the gallery due
                    to ambiguous way finding signage.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className={`${styles.splitBlock} ${styles.splitBlockCream}`}>
            <div className={`${styles.splitSide} ${styles.splitCreamLeft}`}>
              ...
              <p className={styles.splitBodyText}>
                Creating an app for AGO to help users with way finding and
            ...
            <div className={`${styles.splitSide} ${styles.splitCreamRight}`}>
              <div className={styles.findingsList}>
                <div className={styles.findingItem}>
                  <p className={styles.findingText}>
                    <strong>Way finding&nbsp;&ndash;</strong> GPS-like
                    navigation within the building with step-by-step directions.
                  </p>
                </div>
                <div className={styles.findingItem}>
                  <p className={styles.findingText}>
                    <strong>360 virtual tour&nbsp;&ndash;</strong> Immersive,
                    panoramic views of the AGO&rsquo;s galleries.
                  </p>
                </div>
                <div className={styles.findingItem}>
                  <p className={styles.findingText}>
                    <strong>Collections&nbsp;&ndash;</strong> A searchable
                    database of artworks with images of art work and
                    descriptions.
                  </p>
                </div>
                <div className={styles.findingItem}>
                  <p className={styles.findingText}>
                    <strong>Expert insight&nbsp;&ndash;</strong> Commentary from
                    curators and art historians.
                  </p>
                </div>
                <div className={styles.findingItem}>
                  <p className={styles.findingText}>
                    <strong>Ticket and event calendar&nbsp;&ndash;</strong>{" "}
                    Purchase and store tickets within the app and a real-time
                    calendar of exhibitions, tours, and events.
                  </p>
                </div>
                <div className={styles.findingItem}>
                  <p className={styles.findingText}>
                    <strong>Guest access&nbsp;&ndash;</strong> Users don&rsquo;t
                    need to create a profile, and can get tickets emailed to
                    them.
                  </p>
                </div>
              </div>
              ...
              <div className={styles.medFiGrid}>
                <div className={styles.medFiItem}>
                  <div className={styles.medFiImageWrap}>
                    <Image
                      src="/work/ago-app/mid1.svg"
                      alt="Screen 1"
                      width={400}
                      height={600}
                      className={styles.medFiImage}
                    />
                  </div>
            ...
            <div className={styles.testingFrame}>
              ...
              <div className={styles.testingGrid}>
                <div className={styles.testingStatItem}>
                  ...
                  <p className={styles.testingStatText}>
                    We conducted 7 usability testing sessions to evaluate the
                    AGO app experience.
                  </p>
                </div>
                <div className={styles.testingStatItem}>
                  ...
                  <p className={styles.testingStatText}>
                    Participants did 5 key tasks that reflected key app
                    features.
                  </p>
                </div>
                <div className={styles.testingStatItem}>
                  ...
                  <p className={styles.testingStatText}>
                    Our participants were primarily aged 18–28, including Humber
                ...
                <div className={styles.testingStatItem}>
                  ...
                  <p className={styles.testingStatText}>
                    To ensure flexibility, some sessions were conducted
                    in-person for direct observation, while others were done
          ...
          <div className={styles.testingBlock}>
            <div className={styles.testingFrame}>
              ...
              <p className={styles.metricsNote}>
                Task success rate – percentage of users who successfully
                  ...
                  <tbody>
                    <tr className={styles.metricsRow}>
                      <td className={styles.metricsCell}>
                        1. Browse the information on &lsquo;What&rsquo;s
                        On&rsquo;, then find expert insights for that
                        collection.
                      </td>
                    ...
                    <tr className={styles.metricsRow}>
                      <td className={styles.metricsCell}>
                        2. Find your way to European art, take a virtual tour,
                        and find the information on &lsquo;The Lady of
                        Shalott&rsquo;.
                      </td>
                      <td className={styles.metricsCell}>100%</td>
                    ...
                    <tr className={styles.metricsRow}>
                      <td className={styles.metricsCell}>
                        3. Find the bistro (using the map).
                      </td>
                      <td className={styles.metricsCell}>100%</td>
                    ...
                    <tr className={styles.metricsRow}>
                      <td className={styles.metricsCell}>
                        4. Book a ticket for the Culture: Hip Hop and
                    ...
                    <tr className={styles.metricsRow}>
                      <td className={styles.metricsCell}>
                        5. Find an Event using the calendar for April 14 2025.
                      </td>
                      <td className={styles.metricsCell}>100%</td>
          ...
          <div className={styles.kfBlock}>
            <div className={styles.kfFrame}>
                ...
                <div className={styles.kfBeforeAfter}>
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f1-before1.svg"
                        alt="Before 1"
                        width={400}
                        height={600}
                        className={styles.kfScreen}
                      />
                    </div>
                  ...
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f1-after1.svg"
                        alt="After 1"
                        width={400}
                        height={600}
                        className={styles.kfScreen}
              ...
              <div className={styles.kfItem}>
                ...
                <div className={styles.kfQuote}>
                  &ldquo;How do I know which one is &lsquo;Lady Shallot&rsquo;?
                  I can&rsquo;t see the picture properly and there is no
                  labelling&rdquo;
                  <span className={styles.kfQuoteSub}>
                    &ldquo;What am I supposed to do here?&rdquo;
                  </span>
                </div>
                <div className={styles.kfBeforeAfter}>
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f2-before1.svg"
                        alt="Before 1"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f2-before2.svg"
                        alt="Before 2"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                  ...
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f2-after1.svg"
                        alt="After 1"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f2-after2.svg"
                        alt="After 2"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f2-after3.svg"
                        alt="After 3"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
              ...
              <div className={styles.kfItem}>
                ...
                <div className={styles.kfBeforeAfter}>
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f3-before1.svg"
                        alt="Before 1"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f3-before2.svg"
                        alt="Before 2"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f3-before3.svg"
                        alt="Before 3"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                  ...
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f3-after1.svg"
                        alt="After 1"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f3-after2.svg"
                        alt="After 2"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
              ...
              <div className={styles.kfItem}>
                ...
                <div className={styles.kfQuote}>
                  &ldquo;I&rsquo;m confused because the map page doesn&rsquo;t
                  show a map&rdquo;
                </div>
                <div className={styles.kfBeforeAfter}>
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f4-before1.svg"
                        alt="Before 1"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f4-before2.svg"
                        alt="Before 2"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                  ...
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f4-after1.svg"
                        alt="After 1"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f4-after2.svg"
                        alt="After 2"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f4-after3.svg"
                        alt="After 3"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
              ...
              <div className={styles.kfItem}>
                ...
                <div className={styles.kfBeforeAfter}>
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f5-before1.svg"
                        alt="Before 1"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f5-before2.svg"
                        alt="Before 2"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                  ...
                  <div className={styles.kfGroup}>
                    <div className={styles.kfScreens}>
                      <Image
                        src="/work/ago-app/f5-after1.svg"
                        alt="After 1"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
                      />
                      <Image
                        src="/work/ago-app/f5-after2.svg"
                        alt="After 2"
                        width={400}
                        height={600}
                        className={styles.kfScreenSm}
          ...
          <div className={styles.takeawaysBlock}>
            <div className={styles.takeawaysCard}>
              ...
              <p className={styles.takeawaysText}>
                This project helped me understand how thoughtful UX design can
                make cultural spaces more accessible and engaging for a wider
                audience. I learned to simplify complex information, design for
                diverse user needs, and balance physical and digital experiences
            ...
            <div className={styles.takeawaysCard}>
              ...
              <p className={styles.takeawaysText}>
                In the future, the app could expand its VR experiences and
                introduce personalized exhibit recommendations based on user
                interests. Additional user testing with diverse visitor groups
                would help refine accessibility features and improve the overall
